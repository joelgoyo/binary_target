                ...
                <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input class="form-control rounded-0" type="text" id="issue" name="issue" value="{{ $ticket->issue }}"/>
                                    </div>
                                    ...
                                    <div class="col-12 mt-1">
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <select name="priority" class="custom-select priority form-control rounded-0">
                                    ...
                                    <div class="col-12 mt-3 mb-2" id="load_chat">
                                        ...
                                        <textarea class="form-control rounded-0" name="message" required id="message" rows="2"></textarea>
